...
\hypertarget{allan-variance}{%
\chapter{Allan Variance}\label{allan-variance}}
...
\protect\hypertarget{def:unnamed-chunk-3}{}{\label{def:unnamed-chunk-3} }We
consider the AV at dyadic scales (\(\tau_j\)) starting from local
averages of the process which can be denoted as
...
\BeginKnitrBlock{remark}[fsgsv]
\iffalse{} {Remark (fsgsv). } \fi{}The definition of the AV is actually
valid for \ldots{}
