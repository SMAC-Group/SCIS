...
### Consistency of MOAV Estimator

```{lemma, lemmconsistencyAV, name = "Consistency of the Maximum-Overlapping AV Estimator"}
...
```{proof, pf_lemmconsistencyAV, name = "Consistency of the Maximum-Overlapping AV Estimator"}
TO BE ADDED
```
<br>
